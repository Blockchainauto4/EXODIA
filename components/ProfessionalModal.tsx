      ...
      <div className="relative w-full max-w-xl bg-white rounded-[2.5rem] shadow-[0_0_100px_rgba(0,0,0,0.4)] overflow-hidden animate-fade-in border border-white/20 flex flex-col max-h-[95vh]">
        ...
        {step < 3 && (
          <div className="bg-slate-900 p-8 text-white shrink-0">
            ...
            <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mb-4">Integre sua unidade à rede de triagem local</p>
          </div>
        )}
        ...
        <div className="p-8 overflow-y-auto custom-scrollbar">
          {step === 1 && (
            <div className="space-y-6 animate-fade-in">
              <div className="p-5 bg-blue-50 border border-blue-100 rounded-2xl">
                <p className="text-[10px] font-black uppercase text-blue-700 tracking-widest mb-1">Valor Regional</p>
                <h3 className="text-lg font-black text-slate-900 uppercase tracking-tighter leading-none">Presença na Busca 'Perto de Mim'</h3>
              </div>
          ...
          {step === 3 && (
            <div className="py-12 text-center space-y-8 animate-fade-in">
              <div className="w-24 h-24 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center text-4xl mx-auto shadow-2xl">
                📋
              </div>
              <div>
                <h2 className="text-3xl font-black uppercase tracking-tighter text-slate-900 leading-none">Perfil de Unidade Ativo</h2>
                <p className="text-blue-600 font-bold uppercase text-[10px] tracking-widest mt-4">Sua unidade já está mapeada na busca regional</p>
              </div>
              <button 
                onClick={onClose}
