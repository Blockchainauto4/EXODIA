    ...
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-2xl bg-white rounded-3xl shadow-2xl overflow-hidden animate-fade-in">
        <div className="bg-blue-600 p-8 text-white">
          ...
          <p className="text-blue-100 font-medium">O sistema IA Hospital utiliza infraestrutura avançada para triagem local. Veja como habilitar recursos PRO.</p>
        </div>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-xs leading-relaxed">Localização precisa de unidades de saúde no seu bairro através de IA.</p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-xs leading-relaxed">Conexão direta com a infraestrutura do Google para análise em tempo real via IA Studio.</p>
                </div>
              </div>
            </div>

            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200">
              <h4 className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-4">Níveis de Acesso</h4>
