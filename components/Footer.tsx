      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="mb-20 bg-gradient-to-br from-slate-900 to-black border border-white/10 rounded-[3rem] p-10 md:p-14 flex flex-col lg:flex-row items-center justify-between gap-12 relative overflow-hidden shadow-2xl">
          ...
          <div className="text-center lg:text-left relative z-10 max-w-2xl">
            <span className="inline-block px-4 py-1.5 bg-teal-600/20 text-teal-300 rounded-full text-[10px] font-black uppercase tracking-[0.3em] mb-6 border border-teal-500/20">Para Unidades de Saúde</span>
            <h2 className="text-3xl md:text-4xl font-black uppercase tracking-tighter mb-4 text-white leading-none">Integre sua Unidade à Nossa Rede</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 mb-20">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-[8px] text-teal-400 font-black uppercase tracking-[0.2em]">Certificação de Segurança Rizk</p>
              </div>
            </div>
          </div>
          ...
          <nav aria-label="Segurança e Compliance">
            <h3 className="font-black mb-8 text-white text-xs uppercase tracking-[0.2em]">Segurança & Compliance</h3>
            <ul className="space-y-4 text-slate-300 text-sm font-bold uppercase tracking-widest">
