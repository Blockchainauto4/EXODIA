...
const JobsBoard: React.FC<JobsBoardProps> = ({ location }) => {
  // Filtro dinâmico: Mostra apenas se bater com a cidade ou estado e especialidade
  const filteredJobs = MOCK_JOBS.filter(job => 
    (job.city.toLowerCase() === location.city.toLowerCase() || location.city === 'sua região') &&
    (job.specialty.toLowerCase() === (location.specialty || '').toLowerCase())
  );
