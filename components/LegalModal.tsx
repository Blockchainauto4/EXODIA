      ...
      <div className="relative w-full max-w-4xl bg-white h-[85vh] rounded-[3rem] shadow-2xl flex flex-col overflow-hidden animate-fade-in border border-white/10">
        ...
        <div className="bg-slate-900 p-8 text-white flex justify-between items-center shrink-0">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h2 className="text-2xl font-bold uppercase tracking-tighter leading-none">{title}</h2>
            </div>
        ...
        <div className="flex-grow overflow-y-auto p-8 md:p-12 custom-scrollbar bg-slate-50">
          <div className="prose prose-slate max-w-none text-slate-600">
            ...
            {type === 'about' && (
              <div className="space-y-12">
                <div className="bg-slate-900 text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden border border-white/5">
                  <div className="absolute top-0 right-0 p-8 opacity-5 text-9xl font-bold">IAH</div>
                  <h3 className="text-2xl font-bold uppercase mb-4 text-teal-400">Nossa Visão Institucional</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                  <div className="space-y-6">
                    <h3 className="text-xl font-bold uppercase text-slate-900 border-l-4 border-teal-600 pl-4 tracking-tighter">Liderança & Estratégia</h3>
                  ...
                  <div className="space-y-6">
                    <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm space-y-4">
                      <h4 className="text-xs font-bold text-slate-400 uppercase tracking-widest">Pilares da Plataforma</h4>
                    ...
                    <div className="p-8 bg-teal-600 text-white rounded-[2.5rem] shadow-xl">
                      <p className="text-xs font-bold uppercase tracking-widest text-teal-100 mb-2">Nosso Manifesto</p>
                      <p className="text-sm font-medium leading-relaxed italic">
                        ...
                        <br/><br/>
                        <span className="font-bold uppercase tracking-widest text-white">— Board of Directors</span>
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {type === 'privacy' && (
              <div className="space-y-6">
                <h3 className="text-xl font-bold uppercase text-slate-900">Privacidade & Protocolo de Dados</h3>
            ...
            {type === 'terms' && (
              <div className="space-y-6">
                <h3 className="text-xl font-bold uppercase text-slate-900">Governança & Termos de Uso</h3>
                
                <div className="p-8 bg-slate-900 text-white rounded-[2rem] border-l-8 border-teal-600">
                  <h4 className="text-sm font-bold text-teal-400 uppercase tracking-widest mb-3">Aviso Importante</h4>
            ...
            {type === 'data' && (
              <div className="space-y-6">
                <h3 className="text-xl font-bold uppercase text-slate-900">Segurança Cibernética & Auditoria</h3>
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex gap-4 items-start p-5 bg-white rounded-2xl border border-slate-100 shadow-sm">
                      ...
                      <div>
                        <p className="font-bold text-xs uppercase text-slate-900 mb-1">{item.t}</p>
        ...
        <div className="p-8 bg-white border-t border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-6 shrink-0">
          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Uma Iniciativa de Bruno Audric Bittencourt Rizk</p>
          <button 
            onClick={onClose}
            className="w-full sm:w-auto px-12 py-5 bg-teal-600 hover:bg-teal-700 text-white font-bold uppercase tracking-widest rounded-2xl transition-all shadow-xl shadow-teal-100 border-b-4 border-teal-800"
          >
            Validar & Acessar
          </button>
        </div>
