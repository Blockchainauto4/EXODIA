      ...
      <div className="relative w-full max-w-4xl bg-white h-[85vh] rounded-[3rem] shadow-2xl flex flex-col overflow-hidden animate-fade-in border border-white/10">
        ...
        <div className="bg-slate-900 p-8 text-white flex justify-between items-center shrink-0">
          <div>
            <div className="flex items-center gap-2 mb-1">
              <div className="w-5 h-5 bg-blue-600 rounded flex items-center justify-center text-[10px] font-bold">IA</div>
              <h2 className="text-2xl font-black uppercase tracking-tighter leading-none">{title}</h2>
            </div>
            <p className="text-slate-500 text-[10px] font-bold uppercase tracking-widest">IA Hospital Enterprise • Corporate Governance v3.0</p>
          </div>
          <button 
            onClick={onClose} 
        ...
        <div className="flex-grow overflow-y-auto p-8 md:p-12 custom-scrollbar bg-slate-50">
          <div className="prose prose-slate max-w-none text-slate-600">
            ...
            {type === 'about' && (
              <div className="space-y-12">
                <div className="bg-slate-900 text-white p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden border border-white/5">
                  <div className="absolute top-0 right-0 p-8 opacity-5 text-9xl font-black">ENT</div>
                  <h3 className="text-2xl font-black uppercase mb-4 text-blue-400">Institutional Vision</h3>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                  <div className="space-y-6">
                    <h3 className="text-xl font-black uppercase text-slate-900 border-l-4 border-blue-600 pl-4 tracking-tighter">Liderança & Estratégia</h3>
                  ...
                  <div className="space-y-6">
                    <div className="bg-white p-8 rounded-[2.5rem] border border-slate-200 shadow-sm space-y-4">
                      <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest">Enterprise Pillars</h4>
                      <ul className="space-y-3">
                        <li className="flex items-center gap-3 text-xs font-bold text-slate-700">
                          <span className="w-2 h-2 bg-blue-600 rounded-full"></span> Governança de Dados Transparente
                        </li>
                        <li className="flex items-center gap-3 text-xs font-bold text-slate-700">
                          <span className="w-2 h-2 bg-blue-600 rounded-full"></span> Alta Disponibilidade Sistêmica
                        </li>
                        <li className="flex items-center gap-3 text-xs font-bold text-slate-700">
                          <span className="w-2 h-2 bg-blue-600 rounded-full"></span> Auditoria em Tempo Real via IA
                        </li>
                        <li className="flex items-center gap-3 text-xs font-bold text-slate-700">
                          <span className="w-2 h-2 bg-blue-600 rounded-full"></span> Arquitetura de Rede Rizk-Certified
                        </li>
                      </ul>
                    </div>
                    
                    <div className="p-8 bg-blue-600 text-white rounded-[2.5rem] shadow-xl">
                      <p className="text-xs font-black uppercase tracking-widest text-blue-100 mb-2">Corporate Manifesto</p>
            ...
            {type === 'privacy' && (
              <div className="space-y-6">
                <h3 className="text-xl font-black uppercase text-slate-900">Privacidade & Protocolo Corporativo</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-6 bg-white border border-slate-200 rounded-2xl">
                    <h4 className="font-bold text-slate-800 text-sm mb-2">Data Integrity</h4>
                  ...
                  <div className="p-6 bg-white border border-slate-200 rounded-2xl">
                    <h4 className="font-bold text-slate-800 text-sm mb-2">Enterprise Encryption</h4>
                    <p className="text-xs leading-relaxed">
                      Utilizamos chaves de criptografia geradas dinamicamente sob protocolos Rizk-256, assegurando que o canal de transmissão entre o usuário e o centro de processamento seja inviolável.
                    </p>
                  </div>
                </div>
              </div>
            ...
            {type === 'terms' && (
              <div className="space-y-6">
                <h3 className="text-xl font-black uppercase text-slate-900">Governance & Usage Policy</h3>
                
                <div className="p-8 bg-slate-900 text-white rounded-[2rem] border-l-8 border-blue-600">
                  <h4 className="text-sm font-black text-blue-400 uppercase tracking-widest mb-3">Institutional Disclaimer</h4>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm leading-relaxed text-slate-500">
                    O uso do sistema implica na aceitação de que esta é uma ferramenta de triagem pré-clínica. Nossa responsabilidade corporativa limita-se à entrega da orientação mais precisa baseada nos dados fornecidos pelo usuário.
                  </p>
                </div>
              </div>
            )}
            ...
            {type === 'data' && (
              <div className="space-y-6">
                <h3 className="text-xl font-black uppercase text-slate-900">Cyber Resilience & Audit</h3>
                ...
                <div className="space-y-4">
                  {[
                    { t: 'Multi-Cloud Strategy', d: 'Redundância geográfica em três continentes para zero downtime.' },
                    { t: 'AI Governance', d: 'Monitoramento contínuo para evitar alucinações de modelo e garantir conformidade ética.' },
                    { t: 'Zero Trust Access', d: 'Nenhum dado é acessado sem autenticação multifatorial Rizk-Key.' }
                  ].map((item, i) => (
                    <div key={i} className="flex gap-4 items-start p-5 bg-white rounded-2xl border border-slate-100 shadow-sm">
                      <div className="w-10 h-10 bg-slate-900 text-blue-400 rounded-xl flex items-center justify-center text-xs font-bold shrink-0">{i+1}</div>
                      <div>
        ...
        <div className="p-8 bg-white border-t border-slate-200 flex flex-col sm:flex-row justify-between items-center gap-6 shrink-0">
          <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Enterprise Division • Directed by Bruno Audric Bittencourt Rizk</p>
          <button 
            onClick={onClose}
            className="w-full sm:w-auto px-12 py-5 bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-widest rounded-2xl transition-all shadow-xl shadow-blue-100 border-b-4 border-blue-800"
          >
            Validar & Acessar
          </button>
        </div>
